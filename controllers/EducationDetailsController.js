...
const getEducationDetails =async(req,res)=>{
    try{
        const getData = await EducationDetails.find().select('degree year institute grade')
...
module.exports = { saveEducationDetails, getEducationDetails,deleteEducationDetails,updateEducationDetails};